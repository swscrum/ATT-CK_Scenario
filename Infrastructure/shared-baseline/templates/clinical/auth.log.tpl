...
{BSD-14-08h-45m} {HOST} sshd[1101]: Connection from 10.30.0.7 to apache (10.40.0.2:22) initiated by luke.smith
...
{BSD-11-08h-44m} {HOST} sshd[1322]: Connection from 10.30.0.7 to apache (10.40.0.2:22) initiated by luke.smith
...
{BSD-9-08h-46m} {HOST} sshd[1611]: Connection from 10.30.0.7 to apache (10.40.0.2:22) initiated by luke.smith
...
{BSD-7-08h-42m} {HOST} sshd[1822]: Connection from 10.30.0.7 to apache (10.40.0.2:22) initiated by luke.smith
...
{BSD-4-09h-12m} {HOST} sshd[2011]: Connection from 10.30.0.7 to apache (10.40.0.2:22) initiated by luke.smith
...
{BSD-1-08h-44m} {HOST} sshd[2422]: Connection from 10.30.0.7 to apache (10.40.0.2:22) initiated by luke.smith
